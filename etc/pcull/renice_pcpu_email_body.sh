...
# pcull when it renices processes.  Note that this is sourced from the main 
...
This is an automated message from Odyssey access node $HOSTNAME.  One of the processes you're running has exceeded the CPU limit that we've put in place to keep the access nodes responsive for all users.  Thus, your process has been lowered in priority.
