...
This is an automated message from Odyssey access node $HOSTNAME.  One of the processes you were running exceeded the combined CPU and runtime limit that we've put in place to keep the access nodes responsive for all users.  Thus, your process has been killed.
